...
Namespace ScreenShot
    ...
    Public Class ScreenCapture
        ...
        Public Function CaptureWindow(ByVal handle As IntPtr) As Bitmap
            ...
            Dim img As Bitmap = Bitmap.FromHbitmap(hBitmap)
...
Handler:
            Dim img2 As Bitmap = Bitmap.FromFile("error.bmp")
            Return img2
